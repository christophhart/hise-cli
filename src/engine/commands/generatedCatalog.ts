...
export const GENERATED_COMMAND_CATALOG = {
	"schemaVersion": 3,
	"common": {
		"syntax": [
			{
	...
	"modes": [
		{
			"id": "analyse",
			"title": "Analyse mode",
			"summary": "Interactive analyse operations.",
			"vocabulary": "",
			"invocation": [],
			"notes": [],
			"antiPatterns": [],
		...
		},
		{
			"id": "api",
			"title": "Api mode",
			"summary": "Interactive api operations.",
			"vocabulary": "",
			"invocation": [],
			"notes": [],
			"antiPatterns": [],
		...
		},
		{
			"id": "assets",
			"title": "Assets mode",
			"summary": "Interactive assets operations.",
			"vocabulary": "",
			"invocation": [],
			"notes": [],
			"antiPatterns": [],
		...
		},
		{
			...
			"vocabulary": "Available builder module types (use the exact ID after add):\nAHDSR, Analyser, Arpeggiator, ArrayModulator, AudioLooper, CC2Note, CCSwapper, ChannelFilter, ChannelSetter, ChokeGroupProcessor, Chorus, Constant, Convolution, CurveEq, Delay, Dynamics, EmptyFX, EventDataEnvelope, EventDataModulator, FlexAHDSR, GlobalEnvelopeModulator, GlobalModulatorContainer, GlobalStaticTimeVariantModulator, GlobalTimeVariantModulator, GlobalVoiceStartModulator, HardcodedEnvelopeModulator, HardcodedMasterFX, HardcodedPolyphonicFX, HardcodedSynth, HardcodedTimevariantModulator, HarmonicFilter, HarmonicFilterMono, KeyNumber, LFO, LegatoWithRetrigger, MPEModulator, MacroModulationSource, MacroModulator, MatrixModulator, MidiController, MidiMetronome, MidiMuter, MidiPlayer, Noise, NoiseGrainPlayer, PhaseFX, PitchWheel, PolyScriptFX, PolyphonicFilter, PolyshapeFX, Random, ReleaseTrigger, RouteFX, Saturator, ScriptEnvelopeModulator, ScriptFX, ScriptProcessor, ScriptSynth, ScriptTimeVariantModulator, ScriptVoiceStartModulator, ScriptnodeVoiceKiller, SendContainer, SendFX, ShapeFX, SilentSynth, SimpleEnvelope, SimpleGain, SimpleReverb, SineSynth, SlotFX, StereoFX, StreamingSampler, SynthChain, SynthGroup, TableEnvelope, Transposer, Velocity, WaveSynth, WavetableSynth",
			"invocation": [
				{
					"title": "Invocation 1",
					"argv": [
		...
		},
		{
			"id": "compile",
			"title": "Compile mode",
			"summary": "Interactive compile operations.",
			"vocabulary": "",
			"invocation": [],
			"notes": [],
			"antiPatterns": [],
		...
		},
		{
			...
			"vocabulary": "Available ScriptNode factories and nodes. Use <factory>.<node> when adding:\ncontrol: bang, bipolar, blend, branch_cable, cable_expr, cable_pack, cable_table, change, clone_cable, clone_forward, clone_pack, compare, converter, delay_cable, file_analyser, input_toggle, intensity, locked_mod, locked_mod_unscaled, logic_op, midi_cc, minmax, normaliser, pack2_writer, pack3_writer, pack4_writer, pack5_writer, pack6_writer, pack7_writer, pack8_writer, pack_resizer, pma, pma_unscaled, ppq, random, resetter, sliderbank, tempo_sync, transport, unscaler, voice_bang, xfader, xy, midi, smoothed_parameter, smoothed_parameter_unscaled, timer\nenvelope: voice_manager, ahdsr, extra_mod_gate, flex_ahdsr, global_mod_gate, silent_killer, simple_ar\nrouting: local_cable, local_cable_unscaled, public_mod, event_data_reader, event_data_writer, global_cable, global_receive, global_send, matrix, ms_decode, ms_encode, receive, selector, send\nanalyse: fft, goniometer, oscilloscope, specs\ncontainer: branch, chain, clone, dynamic_blocksize, fix128_block, fix16_block, fix256_block, fix32_block, fix64_block, fix8_block, fix_blockx, frame1_block, frame2_block, framex_block, midichain, modchain, multi, no_midi, offline, oversample, oversample16x, oversample2x, oversample4x, oversample8x, repitch, sidechain, soft_bypass, split\ncore: clock_ramp, extra_mod, faust, file_player, fix_delay, fm, gain, global_mod, granulator, matrix_mod, mono2stereo, oscillator, peak, peak_unscaled, phasor, phasor_fm, pitch_mod, ramp, recorder, smoother, snex_node, snex_osc, snex_shaper, stretch_player, table\ndynamics: comp, envelope_follower, gate, limiter, updown_comp\nfilters: allpass, biquad, convolution, ladder, linkwitzriley, moog, one_pole, ring_mod, svf, svf_eq\nfx: bitcrush, haas, phase_delay, pitch_shift, reverb, sampleandhold\njdsp: jchorus, jcompressor, jdelay, jdelay_cubic, jdelay_thiran, jlinkwitzriley, jpanner\nmath: abs, add, clear, clip, div, expr, fill1, fmod, intensity, inv, map, mod2sig, mod_inv, mul, neural, pack, pi, pow, rect, sig2mod, sin, sqrt, square, sub, table, tanh\ntemplate: bipolar_mod, dry_wet, feedback_delay, freq_split2, freq_split3, freq_split4, freq_split5, mid_side, softbypass_switch2, softbypass_switch3, softbypass_switch4, softbypass_switch5, softbypass_switch6, softbypass_switch7, softbypass_switch8",
			"invocation": [
				{
					"title": "Invocation 1",
					"argv": [
					...
					"recipes": {
						...
						"tui": {
							...
							"lines": [
								"/dsp",
								"cd \"Script FX1\"",
								"screenshot module \"Script FX1\" scale \"50%\" file patch.png"
							],
							"display": "/dsp\ncd \"Script FX1\"\nscreenshot module \"Script FX1\" scale \"50%\" file patch.png"
						}
					},
		...
		{
			"id": "hise",
			"title": "HISE runtime control",
			"summary": "Launch, inspect, capture, profile, and shut down the running HISE application.",
			"vocabulary": "",
			"invocation": [],
			"notes": [
				"Use the update wizard to pull the latest CI-green HISE develop commit, rebuild it, and optionally relaunch HISE. hise-cli update is a separate shell-only self-update for hise-cli itself."
			],
			"antiPatterns": [],
			"quickStart": [],
			"concepts": [],
			"commands": [
				{
					...
					"mode": "hise",
					"title": "Status",
					"purpose": "Show HISE connection status and current project information.",
					"tags": [
						"hise",
						"runtime",
						"status"
				...
				},
				{
					...
					"mode": "hise",
					"title": "Launch HISE",
					"purpose": "Launch HISE and wait for its REST API to become available.",
					"tags": [
						"hise",
						"runtime",
						"launch"
				...
				},
				{
					"id": "hise.shutdown",
					"mode": "hise",
					"title": "Shut down HISE",
					"purpose": "Gracefully quit the running HISE application.",
					"tags": [
						"hise",
						"runtime",
						"shutdown",
				...
				},
				{
					...
					"mode": "hise",
					"title": "Screenshot",
					"purpose": "Capture the HISE interface or a component screenshot.",
					"tags": [
						"hise",
						"runtime",
						"screenshot"
					...
					"recipes": {
						"tui": {
							...
							"lines": [
								"/hise",
								"screenshot at 50% to screenshot.png"
							],
							"display": "/hise\nscreenshot at 50% to screenshot.png"
						}
					}
				},
				{
					...
					"mode": "hise",
					"title": "Profile",
					"purpose": "Record a runtime performance profile.",
					"tags": [
						"hise",
						"runtime",
						"profile"
					...
					"recipes": {
						"tui": {
							...
							"lines": [
								"/hise",
								"profile thread audio for 1000ms"
							],
							"display": "/hise\nprofile thread audio for 1000ms"
						}
					}
		...
		},
		{
			"id": "inspect",
			"title": "Inspect mode",
			"summary": "Interactive inspect operations.",
			"vocabulary": "",
			"invocation": [],
			"notes": [],
			"antiPatterns": [],
		...
		},
		{
			"id": "project",
			"title": "Project mode",
			"summary": "Interactive project operations.",
			"vocabulary": "",
			"invocation": [],
			"notes": [],
			"antiPatterns": [],
		...
		},
		{
			"id": "publish",
			"title": "Publish mode",
			"summary": "Interactive publish operations.",
			"vocabulary": "",
			"invocation": [],
			"notes": [],
			"antiPatterns": [],
		...
		},
		{
			"id": "root",
			"title": "Root commands",
			"summary": "Enter modes and control the interactive HISE shell.",
			"vocabulary": "",
			"invocation": [],
			"notes": [],
			"antiPatterns": [],
			...
			"commands": [
				{
					"id": "cli.update",
					"mode": "root",
					"title": "Update hise-cli",
					"purpose": "Check for and install the latest hise-cli release. This does not update the HISE application.",
					"tags": [
						"update",
						"cli",
						"release"
				...
				},
				{
					...
					"mode": "root",
					"title": "Exit",
					"purpose": "Leave the current mode or quit",
					"tags": [
						"navigation"
					],
					"aliases": [
				...
				},
				{
					...
					"mode": "root",
					"title": "AI",
					"purpose": "Enter the embedded agent",
					"tags": [
						"agent"
					],
					"aliases": [],
				...
				},
				{
					...
					"mode": "root",
					"title": "How",
					"purpose": "Explain a task using TUI recipes",
					"tags": [
						"help",
						"agent"
					],
				...
				},
				{
					...
					"mode": "root",
					"title": "Research",
					"purpose": "Research HISE documentation",
					"tags": [
						"documentation"
					],
					"aliases": [],
					...
					"recipes": {
						"tui": {
							"title": "TUI",
							"lines": [
								"/research ScriptSlider callbacks"
							],
							"display": "/research ScriptSlider callbacks"
						}
					}
				},
				{
				...
				},
				{
					...
					"mode": "root",
					"title": "Resume",
					"purpose": "Resume a paused wizard",
					"tags": [
						"wizard"
					],
					"aliases": [],
				...
				},
				{
					...
					"mode": "root",
					"title": "Compact",
					"purpose": "Toggle compact tree display",
					"tags": [
						"display"
					],
					"aliases": [],
				...
				},
				{
					...
					"mode": "root",
					"title": "Expect",
					"purpose": "Assert workflow output",
					"tags": [
						"workflow"
					],
					"aliases": [],
				...
				},
				{
					...
					"mode": "root",
					"title": "Capture",
					"purpose": "Capture script console output",
					"tags": [
						"workflow"
					],
					"aliases": [],
				...
				},
				{
					...
					"mode": "root",
					"title": "Run",
					"purpose": "Run a workflow command file",
					"tags": [
						"workflow"
					],
					"aliases": [],
				...
				},
				{
					...
					"mode": "root",
					"title": "Parse",
					"purpose": "Parse a workflow without executing it",
					"tags": [
						"workflow"
					],
					"aliases": [],
				...
				},
				{
					...
					"mode": "root",
					"title": "Callback",
					"purpose": "Select a script callback",
					"tags": [
						"script"
					],
					"aliases": [],
				...
				},
				{
					...
					"mode": "root",
					"title": "HISE mode",
					"purpose": "Enter runtime control mode",
					"tags": [
						"navigation"
					],
					"aliases": [],
				...
				},
				{
					...
					"mode": "root",
					"title": "API mode",
					"purpose": "Enter API documentation mode",
					"tags": [
						"navigation"
					],
					"aliases": [],
				...
				},
				{
					...
					"mode": "root",
					"title": "MCP mode",
					"purpose": "Enter MCP documentation mode",
					"tags": [
						"navigation"
					],
					"aliases": [],
		...
		},
		{
			"id": "sampler",
			"title": "Sampler mode",
			"summary": "Interactive sampler operations.",
			"vocabulary": "",
			"invocation": [],
			"notes": [],
			"antiPatterns": [],
		...
		},
		{
			...
			"vocabulary": "Available UI component types (use the exact ID after add):\nScriptButton, ScriptSlider, ScriptComboBox, ScriptFloatingTile, ScriptImage, ScriptLabel, ScriptPanel, ScriptAudioWaveform, ScriptTable, ScriptSliderPack, ScriptedViewport, ScriptMultipageDialog",
			"invocation": [
				{
					"title": "Invocation 1",
					"argv": [
		...
		},
		{
			"id": "undo",
			"title": "Undo mode",
			"summary": "Interactive undo operations.",
			"vocabulary": "",
			"invocation": [],
			"notes": [],
			"antiPatterns": [],
		...
		},
		{
			"id": "wizard",
			"title": "Wizard mode",
			"summary": "Run data-driven HISE setup and export workflows.",
			"vocabulary": "",
			"invocation": [],
			"notes": [],
			"antiPatterns": [],
			...
			"commands": [
				{
					"id": "wizard.update-hise",
					"mode": "wizard",
					"title": "Update HISE",
					"purpose": "Pull the latest CI-green HISE develop commit, rebuild HISE, and optionally relaunch it.",
					"tags": [
						"wizard",
						"update",
						"hise",
					...
					"recipes": {
						"cli": {
							...
							"display": "hise-cli -wizard run update --agent"
						},
						"tui": {
							"title": "TUI",
							"lines": [
					...
					"notes": [
						"The wizard can shut down HISE, discard local changes and clean builds, pull a selected or latest CI-green commit, compile, and relaunch. Rebuilding can take 30 or more minutes."
					]
				},
				{
					"id": "wizard.run",
					"mode": "wizard",
					"title": "Run wizard",
					"purpose": "Start a wizard by its stable ID and provide answers when requested.",
					"tags": [
						"wizard",
						"mutation"
					],
					...
					"recipes": {
						"cli": {
							...
							"display": "hise-cli -wizard run plugin_export --agent"
						},
						"tui": {
							"title": "TUI",
							"lines": [
...
} as const satisfies CommandCatalog;
